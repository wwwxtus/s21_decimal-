...
int s21_add(s21_decimal value_1, s21_decimal value_2, s21_decimal *result) {
    ...
    if (value_sign_1 == POSITIVE && value_sign_2 == POSITIVE) {
        ...
        // while(add_overflow_check(value_1, value_2, &temp_res)) {
        //     if(s21_is_greater(value_1, value_2) && get_exponent(value_1) > 0){
        ...
        //     }else if(s21_is_greater(value_2, value_1) && get_exponent(value_2) > 0){
        //         long_division(value_2, ten, &value_2);
        //         set_exponent(&value_2, get_exponent(value_2) - 1);
        //     }
        // }
