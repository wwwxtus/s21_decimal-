...
int s21_add(s21_decimal value_1, s21_decimal value_2, s21_decimal *result) {
    ...
    if (value_sign_1 == POSITIVE && value_sign_2 == POSITIVE) {
        ...
        if(max_exp_v1 - len_v1 > max_exp_v2 - get_normalized_len(value_2) || add_overflow_check(value_1, value_2, &temp_res)){
        ...
        if(max_exp_v2 - len_v2 > max_exp_v1 - get_normalized_len(value_1) || add_overflow_check(value_1, value_2, &temp_res)){
